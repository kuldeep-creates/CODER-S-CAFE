      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <SocialIcon href="https://linkedin.openinapp.link/9yhs0 " icon={<Linkedin size={24} />} />
            <SocialIcon href="https://www.instagram.com/coderscafe_jec?igsh=eWplM3o2ZjE4amdn" icon={<Instagram size={24} />} />
          </div>
        </div>
